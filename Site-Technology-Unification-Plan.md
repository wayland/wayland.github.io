...
> Status: Stages 1–6 executed (through PI switch to `/all-sites/layout.xsl`;
> PP-local layout/`TOP-*.css` retired). Next: Stage 7 (verify §9; siteslist go-live).
...
1. §9 Manual Review completion and any title fixes (OQ-D) — Stage 7.
